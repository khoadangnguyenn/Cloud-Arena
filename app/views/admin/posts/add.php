        ...
        <section class="card panel-card">
            <div class="card-body">
                <div class="admin-module-header">
                    <div>
                        <h1 class="admin-module-title">Thêm tin tức</h1>
                        <p class="admin-module-lead">Tạo bài viết mới cho trang tin tức.</p>
                    </div>
                ...
                <form action="<?php echo URLROOT; ?>/admin/posts/add" method="POST" enctype="multipart/form-data" id="post-form">
                        ...
                        <div class="col-12">
                            ...
                            <div class="admin-rich-editor-wrap">
                                <div id="editor-container">
                                    <textarea name="content" id="content" class="form-control rich-text-editor" rows="12" placeholder="Nhập nội dung..."></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="mt-4 pt-3 border-top" style="border-color: var(--admin-border) !important;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="datetime-local" name="breaking_until" id="breaking_until" class="form-control" disabled>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="mt-4 pt-3 border-top" style="border-color: var(--admin-border) !important;">
                        ...
                        <div class="admin-seo-preview-box" id="seo-preview">
                            <div class="seo-preview-title" id="seo-preview-title">Tiêu đề bài viết - <?php echo htmlspecialchars(SITENAME, ENT_QUOTES, 'UTF-8'); ?></div>
                            <div class="seo-preview-url"><?php echo htmlspecialchars(URLROOT, ENT_QUOTES, 'UTF-8'); ?>/posts/show/tieu-de-bai-viet</div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="meta_keywords" id="meta_keywords" class="form-control" placeholder="game, server, hosting...">
                        </div>
                        <div class="mb-3">
                            <label for="meta_description" class="form-label">Mô tả SEO <span class="seo-counter small text-muted" id="desc-counter">0/160</span></label>
                            <textarea name="meta_description" id="meta_description" class="form-control" rows="3" maxlength="200" placeholder="Mô tả hiển thị trên Google..."></textarea>
                        </div>
                    </div>

                    <div class="text-end mt-4">
                        <button type="submit" class="btn btn-primary" id="btn-save"><i class="fas fa-save"></i> Lưu bài viết</button>
                    </div>
                </form>
            </div>
        </section>
...
<script>
    ...
    new Dropzone('#thumbnail-dropzone', {
        ...
        acceptedFiles: 'image/*',
        addRemoveLinks: true,
        dictDefaultMessage: "<i class='fas fa-cloud-upload-alt' style='font-size:2rem;margin-bottom:10px;display:block;opacity:.6'></i> Kéo thả ảnh hoặc bấm để chọn",
    ...
    if (titleInput) {
        titleInput.addEventListener('input', function () {
            document.getElementById('seo-preview-title').textContent = (this.value || 'Tiêu đề bài viết') + ' - <?php echo htmlspecialchars(SITENAME, ENT_QUOTES, 'UTF-8'); ?>';
        });
    }
