                                    ...
                                    <?php foreach ($data['reviews'] as $review) : ?>
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <form action="<?php echo URLROOT; ?>/admin/reviews/updateStatus/<?php echo $review->id; ?>" method="POST" class="d-flex justify-content-center">
                                            ...
                                            <td class="align-middle">
                                                <form action="<?php echo URLROOT; ?>/admin/reviews/delete/<?php echo $review->id; ?>" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa đánh giá này?');">
