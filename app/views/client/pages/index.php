...
<!-- Hero Section -->
<section class="relative overflow-hidden bg-[#020817] hero-scene" id="hero-parallax">
    <div class="hero-scene__image parallax-layer" data-speed="0.08"></div>
    <div class="hero-scene__fade"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 pt-32 pb-24 sm:px-6 lg:px-8">
        ...
        <div class="text-center space-y-7 max-w-3xl mx-auto">
            ...
            <p class="text-lg text-gray-300 max-w-xl mx-auto leading-relaxed">
                ...
                Khởi động chỉ trong vài phút với công nghệ ảo hóa tiên tiến nhất.
            </p>
        ...
        <div class="hero-cards-wrapper mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <aside class="hero-floating-card hero-card-left">
                ...
                <h3 class="mt-2 text-lg font-semibold text-white">Server Control Panel</h3>
            ...
            <aside class="hero-floating-card hero-floating-card--delayed hero-card-right">
                <p class="text-xs uppercase tracking-widest font-semibold text-violet-300">Social proof</p>
                <h3 class="mt-2 text-lg font-semibold text-white">Customer reviews</h3>
...
<section id="about-us" class="py-24 bg-[#020817] relative border-t border-white/5">
