      ...
      <div class="lg:flex">
        ...
        <div class="p-8 lg:p-16 lg:w-1/2">
          ...
          <div class="flex flex-col sm:flex-row items-center gap-4 mb-10">
            <form id="addToCartForm" action="<?php echo htmlspecialchars(URLROOT, ENT_QUOTES, 'UTF-8'); ?>/cart/add/<?php echo htmlspecialchars($data['product']->id, ENT_QUOTES, 'UTF-8'); ?>" method="POST" class="w-full flex gap-4">
              <input type="number" name="quantity" id="productQuantity" min="1" max="100" value="1" class="w-24 bg-gray-800 border border-gray-700 rounded-xl px-4 py-4 text-white text-center font-bold focus:ring-2 focus:ring-cyan-500/50 outline-none">
