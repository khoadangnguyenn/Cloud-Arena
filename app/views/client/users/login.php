...
<div class="min-h-[80vh] flex items-center justify-center bg-gray-950 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    <!-- Decorative blobs -->
    <div class="absolute top-1/4 left-1/4 w-64 h-64 bg-cyan-500/20 rounded-full blur-3xl"></div>
    <div class="absolute bottom-1/4 right-1/4 w-64 h-64 bg-purple-500/20 rounded-full blur-3xl"></div>
    ...
    <div class="max-w-md w-full space-y-8 bg-gray-900/50 backdrop-blur-xl p-10 rounded-3xl border border-white/5 relative z-10">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-400">
                Chưa có tài khoản? 
                <a href="<?php echo URLROOT; ?>/users/register" class="font-medium text-cyan-400 hover:text-cyan-300 transition-colors">
                    Đăng ký ngay
                </a>
            </p>
        </div>
